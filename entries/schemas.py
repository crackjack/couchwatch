...
class EntryTable(Base):
    ...
    directors = relationship("DirectorTable", secondary=entry_director_association)
    casts = relationship("ActorTable", secondary=entry_actor_association)
    countries = relationship("CountryTable", secondary=entry_country_association)
